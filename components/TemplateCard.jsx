...
import { Bookmark, Check, ArrowUpRight, Copy, Trash2, Sparkles } from 'lucide-react';
  ...
  return (
    <div className="card-3d-wrap">
      <div
        ...
        className="human-card-3d group flex flex-col overflow-hidden cursor-pointer relative"
      >
        {/* Visual Website Preview Banner */}
        <div className="relative aspect-video w-full overflow-hidden bg-zinc-950 layer-3d-mid">
          <img
          ...
          {/* Category Pill Tag */}
          <div className="absolute top-3 left-3 z-20 px-2.5 py-1 rounded-lg bg-zinc-950/85 border border-white/10 text-[11px] font-medium text-zinc-300 backdrop-blur-md shadow-md layer-3d-front">
            {template.category}
          </div>

          {/* Action Buttons Top Right in 3D Elevation */}
          <div className="absolute top-3 right-3 z-20 flex items-center gap-1.5 layer-3d-front">
            ...
            {onDeleteTemplate && (
              <button
                ...
                className="p-1.5 rounded-lg bg-zinc-950/85 text-zinc-400 border border-white/10 hover:text-red-400 hover:bg-zinc-800 backdrop-blur-md transition-all shadow-md"
            ...
            <button
              ...
              className="p-1.5 rounded-lg bg-zinc-950/85 text-zinc-300 border border-white/10 hover:text-white hover:bg-zinc-800 backdrop-blur-md transition-all shadow-md"
        ...
        {/* Card Content */}
        <div className="p-4 flex flex-col flex-1 layer-3d-front">
