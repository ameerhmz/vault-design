...
export default function TemplateCard({ template, onSelect, isFavorite, onToggleFavorite, onDeleteTemplate, onCopyHex, onShowToast }) {
  ...
  return (
    <div
      ...
      className="human-card group flex flex-col overflow-hidden cursor-pointer"
    >
      {/* Visual Website Preview Banner (High-res screenshot thumbnail) */}
      <div className="relative aspect-video w-full overflow-hidden bg-zinc-950">
        <img
          src={template.image || `https://image.thum.io/get/width/1200/crop/675/delay/7/no-cache/${template.url}`}
          alt={template.title}
